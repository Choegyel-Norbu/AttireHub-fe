        ...
        >
          <div className="max-w-xl">
            ...
            >
              ...
              <Link
                to="/lookbook"
                className="group inline-flex items-center justify-center gap-2 rounded-full px-8 py-4 text-sm font-medium text-primary transition-colors hover:bg-tertiary/10"
              >
